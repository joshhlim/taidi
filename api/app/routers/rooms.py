...
def _as_json(state: RoomState, invite_code: str, game_type: str) -> dict[str, Any]:
    ...
    for _attempt in range(2):
        ...
        try:
            ...
            raise HTTPException(
                ...
                {"message": str(e), "state": _as_json(state, invite_code, game_type)},
            ) from e
        ...
        return _as_json(new_state, invite_code, game_type)
